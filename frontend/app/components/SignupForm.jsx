  ...
  return (
    <div className="terminal-card p-6 sm:p-8 w-full max-w-md animate-fade-in">
      <div className="flex items-center gap-1.5 mb-6">
        ...
        <span className="ml-2 text-xs font-mono text-text-tertiary">auth://register</span>
      </div>

      <h1 className="text-2xl font-bold mb-1">Create account</h1>
      <p className="text-sm text-text-secondary mb-6">Start backtesting your portfolio for free</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-xs font-mono text-text-tertiary uppercase tracking-wider mb-1.5">Name</label>
